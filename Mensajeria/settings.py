...
DATABASES = {
    'default': {
        ...
        'NAME': 'mensajeria',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '0+(@9nyz(pzmaxib+mp_46tl#mxg5kf&ay9@vgf=j1@@1dd4+5'
...
LOGIN_REDIRECT_URL = reverse_lazy('serviciosform')
